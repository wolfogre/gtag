...
//go:generate gtag -types Empty,User,UserName -tags bson,json,json_x .
package regular
...
// TagsJsonX is alias of Tags("json_x")
func (*UserName) TagsJsonX() UserNameTags {
	var v *UserName
	return v.Tags("json_x")
}
